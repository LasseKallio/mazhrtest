...
class ProfileController extends BaseController {
  ...
  */
  ...
  /**
   * Search for MATCHES by job (tm)
   *
   * @return json response
   */
  public function getMatchingProfilesByJob($profile = null)
  {
    try
    {
      if(!$profile) Response::make('Bad request!', '400');

      $matchingProfiles = UserProfile::getMatchingProfilesByJob($profile);
          $response = MzrRestResponse::get(array(), $matchingProfiles);
      return Response::json($response);
